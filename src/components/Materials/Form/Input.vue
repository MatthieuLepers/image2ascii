<template>
  <div
    ...
    <div class="m-form-input__container">
      ...
      <component
        v-if="(props.iconData.icon && type !== 'password') || type === 'password' || props.iconData.text"
        type="button"
        :is="props.iconData.clickable || type === 'password' ? 'button' : 'span'"
        :class="[State.icon, GenerateModifiers('m-form-input__adornment', { clickable: props.iconData.clickable || type === 'password' })]"
        :aria-label="props.iconData.ariaLabel"
        :aria-hidden="!props.iconData.clickable && type !== 'password'"
